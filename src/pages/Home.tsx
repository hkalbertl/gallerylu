...
function Home() {
  return (<>
    ...
    <p className="lead">As of v0.2.0, GalleryLu utilizes the FileLu S5 API, which enables CORS requests by default. Both standard and encrypted images will be served directly from the FileLu server.</p>
    <p className="lead">To get started, please go to the <a href="/config">configuration page</a> and enter your FileLu S5 / API key.</p>
  </>);
}
